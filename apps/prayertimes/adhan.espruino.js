...
var SolarCoordinates = function (julianDay) {
...
var SolarTime = function (date, coordinates) {
...
var polarCircleResolvedValues = function polarCircleResolvedValues(resolver, date, coordinates) {
  ...
  var CalculationParameters =
    ...
    function ( // Name of the method, can be used to apply special behavior in calculations.
...
var TimeComponents = function (num) {
  ...
  this.utcDate = (year, month, date) => {
    const today = new Date(year, month, date);
    return new Date(year, month, date, this.hours, this.minutes - today.getTimezoneOffset(), this.seconds);};
  return this;
};

var PrayerTimes = function (coordinates, date, calculationParameters) {
  ...
  var qibla = function (coordinates) {
...
var SunnahTimes = function (prayerTimes) {
